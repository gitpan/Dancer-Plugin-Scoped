# This Makefile is for the Dancer::Plugin::Scoped extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Dancer/Plugin/Scoped.pm]
#     AUTHOR => q[Roman Galeev <jamhedd@gmail.com>]
#     LICENSE => q[perl]
#     NAME => q[Dancer::Plugin::Scoped]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Dancer/Plugin/Scoped.pm]
#     clean => { FILES=>q[Dancer-Plugin-Scoped-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Dancer/Plugin/Scoped.pm
...
TO_INST_PM = lib/Dancer/Plugin/Scoped.pm

PM_TO_BLIB = lib/Dancer/Plugin/Scoped.pm \
...
DISTNAME = Dancer-Plugin-Scoped
DISTVNAME = Dancer-Plugin-Scoped-0.01
...
manifypods : pure_all  \
	lib/Dancer/Plugin/Scoped.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Dancer/Plugin/Scoped.pm $(INST_MAN3DIR)/Dancer::Plugin::Scoped.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Dancer-Plugin-Scoped' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            The great new Dancer::Plugin::Scoped!' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             perl' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Roman Galeev <jamhedd@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The great new Dancer::Plugin::Scoped!</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Roman Galeev &lt;jamhedd@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Dancer/Plugin/Scoped.pm blib/lib/Dancer/Plugin/Scoped.pm 
